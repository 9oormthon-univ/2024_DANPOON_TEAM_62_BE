...
import com.example.region.domain.Post;
import com.example.region.domain.PostRepository;
...
public class PostService {
    ...
    public List<PostResponse> getPostsByRegion(String region) {
        ...
        return posts.stream()
                .map(post -> new PostResponse(post.getPostId(), post.getTitle(), post.getContent(), post.getUserId(), post.getRegion(), post.getCreatedAt(), post.getUpdatedAt(), post.getLikes()))
